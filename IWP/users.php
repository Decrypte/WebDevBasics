...
<table>
				...
				<?php
					...
					echo '<td><label for="password">Password</label><input id="password" pattern="[a-zA-Z0-9]{8,15}" name="password" type="password" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';   									
